...
const rescheduleAppointment = async (req, res) => {
  try {
    const { appointmentId, newDate, newTime, userId } = req.body
    ...
    // Verify appointment user - using String() to ensure consistent comparison
